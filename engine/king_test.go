...
func TestKingCanCastles(t *testing.T) {
	...
	game := newTestFENPos("r2qkbnr/ppp1pppp/2n5/3p1b2/2B1P3/5N2/PPPP1PPP/RNBQK2R w KQkq - 4 4")
...
func TestKingCantWalkIntoCheck(t *testing.T) {
	...
	game := newTestFENPos("rn1qkbnr/ppp1pppp/8/5b2/2B5/2N5/PPPP1PpP/R1BQ1RK1 w kq - 0 6")
